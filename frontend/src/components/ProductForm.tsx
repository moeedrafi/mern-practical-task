...
interface ProductFormProps {
  onCreate: (newProduct: Product) => Promise<void>;
}

export const ProductForm = ({ onCreate }: ProductFormProps) => {
  const { isPending, productAction, productState } = useProductForm(onCreate);

  return (
    <div className="bg-white p-4 rounded-lg w-[400px] shadow-lg border border-gray-300">
